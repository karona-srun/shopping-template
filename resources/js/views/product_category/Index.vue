      ...
      <div class="card-header container-fluid">
        <div class="row">
          <div class="col-md-6 col-sm-12">
            <p class="p-title">បញ្ជើរប្រភេទក្រុមផលិតផល</p>
          </div>
          <div class="col-md-6 col-sm-12">
            <button
              class="btn btn-black"
          ...
          <tr v-for="(data,i) in loadDatas" v-bind:key="data.id">
            ...
            <td>
              ...
              <button
                ...
                class="btn btn-sm btn-black btn-modal"
                style="margin-right: 10px"
                @click.prevent="showCategory(data.id)"
                data-toggle="modal"
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-black" @click.prevent="refreshModal" data-dismiss="modal">
              បោះបង់
            </button>
            <button
              type="button"
...
export default {
  ...
  computed: {
    ...
    loadData() {
      return this.$store.state.ProductCategory.category;
    },
  },
  created() {
    this.refreshData();
  ...
  methods: {
    ...
    editProductCategory() {;
      this.updateCategories(this.loadData);
      this.refreshData();
      window.location.reload();

    },
    submitDeleteCategories() {
      this.deleteCategories(this.ID);
      this.refreshData();
      this.refreshModal();
    },
    refreshData() {
